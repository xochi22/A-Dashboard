...
import {Typography,Statistic,Card,Space,Table} from 'antd';
import {ShoppingCartOutlined,DollarCircleOutlined,UserOutlined,ShoppingOutlined} from '@ant-design/icons';
import { useEffect, useState } from "react";
import { getOrders, getRevenue, getInventory, getCustomers} from "../../API/API";
...
useEffect(() => {
  ...
  <Space direction="horizontal">
    ...
    style={{
        color:'green',
        backgroundColor:'rgba(0,25,0,0.25)',
        borderRadius:20,
        fontSize:24,
        padding:8
    }}
    ...
    style={{
        color:'red',
        backgroundColor:'rgba(255,25,0,0.25)',
        borderRadius:20,
        fontSize:24,
        padding:8
